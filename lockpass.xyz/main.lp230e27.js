...
(this.wordle = this.wordle || {}),
    (this.wordle.bundle = (function (e) {
        ...
        Sa.innerHTML = `<style>
            ...
            <div class="sections">
              <section>
                ...
                <div class="setting">
                  <div class="text">
                    <div class="title">Modo Daltonismo</div>
                    <div class="description">Cores de alto contraste</div>
                  </div>
                  <div class="control">
        ...
        for (let i = 0; i < 99999; i++) {
            Ta.push(String(i).padStart(5, "0"));
            La.push(String(i).padStart(5, "0"));
        }

        La = shuffle(La, 1.31337);
        ...
        var Ha = new Date(2022, 3, 18, 0, 0, 0, 0);
        function Na(e, a) {
            var s = new Date(e),
                                        ...
                                        function (a) {
                                            ...
                                            switch (t) {
                                                case "hard-mode":
                                                    return void (n
                                                        ? e.addToast(
                                                              "O modo difícil só pode ser ativado no início de uma rodada",
                                                              1500,
                                                              !0
                                                          )
                                                        : ((e.hardMode = o),
        ...
        Cs.innerHTML = `<style>
            ...
            <div class="container">
              ...
              <h1>Distribuição de Tentativas</h1>
              <div id="guess-distribution"></div>
              <div class="footer"></div>
            </div>`;
        var Ls = document.createElement("template");
        Ls.innerHTML = `<div class="statistic-container">
        ...
        Is.innerHTML = `<div class="countdown">
            ...
            <div class="share">
              <button id="share-button">COMPARTILHE<game-icon icon="share"></game-icon>
              </button>
            </div>`;
        var Ms = {
                currentStreak: "Sequência atual",
                maxStreak: "Melhor Sequência",
                winPercentage: "Porcento",
                gamesPlayed: "Jogos",
                gamesWon: "Won",
                ...
                <p><strong>Exemplos:</strong></p>
                  ...
                  <div class="example">
                    <div class="row">
                      ...
                      <game-tile letter="1" evaluation="present" reveal></game-tile>
                      <game-tile letter="3"></game-tile>
                      <game-tile letter="3"></game-tile>
                      <game-tile letter="7"></game-tile>
                    </div>
        ...
        Gs.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
